...
const UserDashboard: React.FC = () => {
  ...
  const leaveUtilization = Math.round(
    ((20 - leaveBalanceData.total) / 20) * 100
  );
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  ...
                  {recentLeaveRequests.filter((req) => req.status === "pending")
                    .length > 0 ? (
                    <List sx={{ p: 0 }}>
                      {recentLeaveRequests
                        ...
                        .map((request) => (
                          ...
                          >
                            <ListItemText
                              ...
                              secondary={`${request.from} - ${request.to} (${
                                request.days
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <TabPanel value={tabValue} index={1}>
                    <Box sx={{ textAlign: "center", py: 4 }}>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        You have no upcoming leave plans. Click "Apply Leave" to
                        request time off.
                      </Typography>
                      <Button
                        variant="contained"
